            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="navbar-buttons ml-auto d-none d-xl-block d-lg-block">
                    <ul>
                        ...
                        <li>
                            <a class="btn btn-theme btn-md" href="submit-property.html">提交信息</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-12 col-sm-12 col-pad">
                <div class="dashboard-nav d-none d-xl-block d-lg-block">
                    <div class="dashboard-inner">
                      <h4>列表</h4>
                        <ul>
                          <li><a href="dashboard.html"><em class="flaticon-dashboard"></em>我的订单</a></li>
                          <li><a href="messages.html"><i class="flaticon-mail"></i> 我的发票 <span class="nav-tag">6</span></a></li>
                            <li><a href="bookings.html"><i class="flaticon-calendar"></i> 我的收藏</a></li>
                        </ul>
                        <h4>我的信息</h4>
                        <ul>
                            <li class="active"><a href="my-profile.html"><i class="flaticon-people"></i>我的信息</a></li>
                            ...
                            <div class="dashboard-message contact-2 bdr clearfix">
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-9">
                                        <form action="/text2/insertuserinfo.action" method="post" enctype="multipart/form-data">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                    <div class="form-group message">
                                                        <label>个人信息</label>
                                                        <textarea class="form-control" name="message" placeholder="请输入您的个人信息"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
