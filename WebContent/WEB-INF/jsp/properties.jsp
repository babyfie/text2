        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                 <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="/text2/regisn.action">
                            注册
                        </a>
             
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="/text2/login.action"  onclick="return window.confirm('请先登录')">
                            我的账户
                        </a>
                    </li>
                </ul>
                            ...
                            <div class="detail">
                                ...
                                <div class="footer">
                                 ...
                                 <div  style="float:right;margin-right:80px;margin-top:10px">
                                	<a href="/text2/login.action" onclick="alert('请先登录')">申请</a>                                </div>
                            </div>
                        </div>
                    </div>
                </div>
