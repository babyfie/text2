            ...
            <div class="col-lg-12">
                ...
                <div class="form-content-box">
                    ...
                    <div class="details">
                        ...
                        <h3>注册账号</h3>
                        <!-- Form start-->
                        <form action="regisn.action" method="GET"> 
                            <div class="form-group">
                                <input type="email" name="email" class="input-text" placeholder="邮箱">
                            </div>  
                            <div class="form-group">
                                <input type="text" name="username" class="input-text" placeholder="个人昵称">
                            </div>
                            <div class="form-group">
                                <input type="password" name="password" class="input-text" placeholder="密码">
                            </div>
                            <div class="form-group">
                                <input type="password" name="confirm_Password" class="input-text" placeholder="确认密码">
                            </div>
                            <div class="form-group">
                            	 <select class="selectpicker search-fields" id="type" name="type" >
                                            <option id="admin">管理员</option>
                                            <option id="zuke">租客</option>
                                        </select>
                            </div>
                    ...
                    <!-- Footer -->
                    <div class="footer">
                        <span>已有一个账号？<a href="/text2/login.action">点击登录</a></span>
                    </div>
                </div>
